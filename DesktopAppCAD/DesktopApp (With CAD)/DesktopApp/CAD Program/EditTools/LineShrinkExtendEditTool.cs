...
namespace DesktopApp.CAD_Program.EditTools
{
    class LineShrinkExtendEditTool : IEditTool
    {
        ...
        void AddLine(Utils.UnitPoint point, DrawTools.Line line)
        {
        ...
        {
            List<DrawTools.Line> lines = new List<CAD_Program.DrawTools.Line>();
        ...
        public eDrawObjectMouseDown OnMouseDown(ICanvas canvas, Utils.UnitPoint point, ISnapPoint snappoint)
        {
            ...
            if (drawitems[0] is DrawTools.Line)
            {
                ...
                {
                    Utils.UnitPoint intersectpoint = Utils.HitUtil.LinesIntersectPoint(edge.P1, edge.P2, originalLp.Line.P1, originalLp.Line.P2);
                    ...
                    if (intersectpoint == Utils.UnitPoint.Empty)
                    {
                        Utils.UnitPoint apprarentISPoint = Utils.HitUtil.FindApparentIntersectPoint(
                            edge.P1,
                            edge.P2,
                            originalLp.Line.P1,
                            originalLp.Line.P2,
