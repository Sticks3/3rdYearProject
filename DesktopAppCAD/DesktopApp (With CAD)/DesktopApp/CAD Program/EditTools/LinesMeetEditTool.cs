...
namespace DesktopApp.CAD_Program.EditTools
{
    class LinePoints
    {
        DrawTools.Line m_line;
        Utils.UnitPoint m_p1;
        Utils.UnitPoint m_p2;
        public Utils.UnitPoint MousePoint;
        ...
        public void SetNewPoints(DrawTools.Line l, Utils.UnitPoint hitpoint, Utils.UnitPoint intersectpoint)
        {
            SetLine(l);
            double hitToVp1 = Utils.HitUtil.Distance(hitpoint, l.P1); // hit point to vertex point
            double ispToVp1 = Utils.HitUtil.Distance(intersectpoint, l.P1); // intersect point to vertex point
    ...
    class LinesMeetEditTool : IEditTool
    {
        ...
        public void SetHitObjects(Utils.UnitPoint point, List<IDrawObject> list)
        {
        }
        public void OnMouseMove(ICanvas canvas, Utils.UnitPoint point)
        {
        }
        public eDrawObjectMouseDown OnMouseDown(ICanvas canvas, Utils.UnitPoint point, ISnapPoint snappoint)
        {
            ...
            if (m_l2Original.Line == null)
            {
                ...
                Utils.UnitPoint intersectpoint = Utils.HitUtil.LinesIntersectPoint(
                ...
                if (intersectpoint == Utils.UnitPoint.Empty)
                {
                    Utils.UnitPoint apprarentISPoint = Utils.HitUtil.FindApparentIntersectPoint(m_l1Original.Line.P1, m_l1Original.Line.P2, m_l2Original.Line.P1, m_l2Original.Line.P2);
                    if (apprarentISPoint == Utils.UnitPoint.Empty)
