...
{
    public class BackgroundLayer : ICanvasLayer, CAD_Program.Utils.ISerialize
    {
        ...
        {
            RectangleF r = Utils.ScreenUtils.ToScreenNormalized(canvas, unitrect);
        ...
        ISnapPoint ICanvasLayer.SnapPoint(ICanvas canvas, Utils.UnitPoint point, List<IDrawObject> otherobj)
        {
