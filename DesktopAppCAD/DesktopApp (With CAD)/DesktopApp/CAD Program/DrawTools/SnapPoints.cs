...
namespace DesktopApp.CAD_Program.DrawTools
{
    ...
    {
        protected Utils.UnitPoint m_snappoint;
        ...
        public SnapPointBase(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
        {
            m_owner = owner;
        ...
        public virtual Utils.UnitPoint SnapPoint
        {
        ...
        {
            Rectangle screenrect = Utils.ScreenUtils.ConvertRect(Utils.ScreenUtils.ToScreenNormalized(canvas, m_boundingRect));
    ...
    {
        public GridSnapPoint(ICanvas canvas, Utils.UnitPoint snappoint)
    ...
    {
        public VertextSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
    ...
    {
        public MidpointSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
            : base(canvas, owner, snappoint)
        {
        }
        public override void Draw(ICanvas canvas)
    ...
    {
        public IntersectSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
            : base(canvas, owner, snappoint)
        {
        }
        public override void Draw(ICanvas canvas)
    ...
    {
        public NearestSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
            : base(canvas, owner, snappoint)
        {
        }
        #region ISnapPoint Members
    ...
    {
        public QuadrantSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
            : base(canvas, owner, snappoint)
        {
        }
        public override void Draw(ICanvas canvas)
    ...
    {
        public DivisionSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
            : base(canvas, owner, snappoint)
        {
        }
        public override void Draw(ICanvas canvas)
    ...
    {
        public CenterSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
            : base(canvas, owner, snappoint)
        {
        }
        public override void Draw(ICanvas canvas)
    ...
    {
        public PerpendicularSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
            : base(canvas, owner, snappoint)
        {
        }
        public override void Draw(ICanvas canvas)
    ...
    {
        public TangentSnapPoint(ICanvas canvas, IDrawObject owner, Utils.UnitPoint snappoint)
            : base(canvas, owner, snappoint)
        {
        }
        public override void Draw(ICanvas canvas)
