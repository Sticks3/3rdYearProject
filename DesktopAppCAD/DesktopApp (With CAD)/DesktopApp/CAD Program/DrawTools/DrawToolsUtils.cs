...
namespace DesktopApp.CAD_Program.DrawTools
{
    public class DrawUtils
    {
        ...
        static public void DrawNode(ICanvas canvas, Utils.UnitPoint nodepoint)
        {
            ...
            r.Inflate(1, 1);
            canvas.Graphics.DrawRectangle(Pens.Black, Utils.ScreenUtils.ConvertRect(r));
        }
        static public void DrawTriangleNode(ICanvas canvas, Utils.UnitPoint nodepoint)
        {
    ...
    abstract class DrawObjectBase
    {
        ...
        abstract public void InitializeFromModel(Utils.UnitPoint point, Layers.DrawingLayer layer, ISnapPoint snap);
        //abstract public void InitializeFromModel(Utils.UnitPoint point, Utils.UnitPoint point1, Utils.UnitPoint point2, DrawingLayer layer, ISnapPoint snap);
